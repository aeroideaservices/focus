module github.com/aeroideaservices/focus/models/aws-s3
...
require (
	...
	github.com/aeroideaservices/focus/services/formatting/strings v0.0.0-20230331082215-1fa5b4db2110 // indirect
