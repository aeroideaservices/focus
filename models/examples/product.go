...
type Product struct {
	...
	ExternalId uint              `focus:"title:Артикул;filterable;unique" validate:"required,notBlank,min=1"`
	...
	Colors     array.StringArray `focus:"title:Цвета;view:colorsInput" validate:"omitempty,unique,dive,iscolor"`
}
